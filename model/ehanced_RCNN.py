...
class ehanced_RCNN(object):
    ...
    def ehanced_RCNN_model(self, scope):
		# input_encode
        cell_fw = tf.contrib.rnn.GRUCell(self.config.bilstm_hidden_dim)
        cell_bw = tf.contrib.rnn.GRUCell(self.config.bilstm_hidden_dim)
        ...
        doc_encode = bilstm_encode(self.doc_embed, self.doc_seq_len, cell_fw, cell_bw, "forward") #[b, seq_len, hiddenX2]
